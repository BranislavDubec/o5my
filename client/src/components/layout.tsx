  ...
  return (
    <div className="min-h-[100dvh] flex bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-0">
        ...
        {/* Mobile Nav Overlay */}
        {mobileNavOpen && (
          <div className="md:hidden fixed inset-0 z-50 bg-background overflow-y-auto" data-testid="mobile-nav">
        ...
        {/* Main Content */}
        <main className="flex-1 min-h-0 overflow-y-auto overscroll-contain p-4 md:p-6 pb-28 md:pb-6 [-webkit-overflow-scrolling:touch]">
          {children}
        </main>
